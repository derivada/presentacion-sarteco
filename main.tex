...
\begin{frame}{Resultados}
    \begin{columns}
        ...
        \textit{Búsquedas aleatorias - radio (m) vs tiempo acumulado (s)  para las 5000 búsquedas en Paris\_Luxembourg\_6}
        \column{0.5\textwidth}
        \textit{Búsquedas aleatorias - Tiempo vs tamaño promedio de los vecindarios en varias nubes y configuraciones (escala log-log)}
    \end{columns}
\end{frame}
